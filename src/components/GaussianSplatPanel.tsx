...
const PANEL_STYLE: CSSProperties = {
    ...
    width: 260,
    padding: 12,
    background: 'linear-gradient(180deg, rgba(var(--panel-rgb), 0.86), rgba(var(--panel-deep-rgb), 0.78))',
    border: '1px solid rgba(var(--accent-rgb), 0.18)',
    borderRadius: 7,
    boxShadow: '0 18px 42px rgba(0,0,0,0.34), 0 0 18px rgba(var(--accent-rgb), 0.06)',
